...
'''),
        ...
        response = self.llm_manager.invoke(
            prompt, schema=schema, question=question)
...
Generate SQL query string'''),
        ...
        response = self.llm_manager.invoke(
            prompt, schema=schema, question=question, parsed_question=parsed_question, unique_nouns=unique_nouns)
...
'''),
        ...
        output_parser = JsonOutputParser()
        response = self.llm_manager.invoke(
            prompt, schema=schema, sql_query=sql_query)
    ...
    def format_results(self, state: dict) -> dict:
        ...
        response = self.llm_manager.invoke(
            prompt, question=question, results=results)
